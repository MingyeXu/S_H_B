...
<table  class='memberSignup jz-memberSignup' cellpadding='0' cellspacing='0'>
	<form action ="action?action=login" method = "POST">
		<tr>
		<td class='itemName'><div class='itemSpace'><span>帐号：</span></div></td>
		<td class='itemCtrl'><div class='itemSpace'><input class='g_itext itemEdit' id='memberSignupAcct' maxlength='50' name = "user_id"/>&nbsp;<font class='g_stress'>*</font></td>
		</div></tr>
		
		<tr>
		<td class='itemName'><div class='itemSpace'><span>密码：</span></div></td>
		<td class='itemCtrl'><div class='itemSpace'><input type='password' class='g_itext itemEdit' id='memberSignupPwd' maxlength='20' name = "user_psw"/>&nbsp;<font class='g_stress'>*</font></td>
		</div></tr>
	
		<tr>
		<td class='itemName'></td>
		<td class='itemCtrl'> 
		<input class='memberSignupBtn g_ibutton'  extClass='g_ibutton' type='submit' value='登 陆'/>
		<a class='memberSignupBtn g_ibutton'  extClass='g_ibutton' href='login.html' >注 册</a>
		<a class='memberSignupBtn g_ibutton'  extClass='g_ibutton' href='productInfo.jsp'>直接进入</a>
		</td>
		</tr>
	</form>
</table>
