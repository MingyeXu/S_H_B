...
<div class='titleText titleText27'>收货信息</div>
</td>
...
<td class='msgText'></td>
    ...
    <h3>请填写收货信息</h3>
    <form action="product?product=orderInfo" method="post">
    <table cellpadding="10" cellspacing="0">
        <tr>
            <td colspan="8" align="center" class="td6">收货基本信息</td>
        </tr>
        <tr>
            <td class="td2">收货人：</td>
            <td class="td5"><input type="text" name="name" /></td>
        </tr>
        <tr>
            <td class="td2">收货地址：</td>
            <td class="td5"><input type="text" name="address" /></td>
        </tr>
        <tr>
            <td class="td2">联系电话：</td>
            <td class="td5"><input type="text" name="phone" /></td>
        </tr>
        <tr>
            <td colspan="2" align="center" class="td6">支付信息</td>
        </tr>
        <tr>
            <td class="td2">支付类别：</td>
            <td class="td5"><input type="radio" name="type" value="wangyin" />网银
            <input type="radio" name="type" value="zhifubao"/>支付宝
            </td>
        </tr>
        <tr>
            <td class="td2">账号：</td>
            <td class="td5"><input type="text" name="account" /></td>
        </tr>

        <tr>
            <td colspan="2" class="td3"><input type="submit" value="提交" id="checkbox2" class="chk_2" /><label for="checkbox2">提交</label></td>
        </tr>
    </table>
