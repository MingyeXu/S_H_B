...
<tr>
<td class='itemLeft'></td>
<td class='itemCenter'><a hidefocus='true' style='outline:none;' href='/col.jsp?id=103' target='_self' onclick='return false;'><span class='itemName0'></span></a></td>
<td class='itemRight'></td>
</tr>
</table>
...
<tr>
<td class='itemLeft'></td
><td class='itemCenter'><a hidefocus='true' style='outline:none;' href='/about.jsp' target='_self' onclick='return false;'><span class='itemName0'></span></a></td>
<td class='itemRight'></td>
</tr>
</table>
</div>
		...
		<table border = "1" width = "80%" height = "40%" align = "center">
			<tr>
				<td width = "30%">
					...
					<form action = "action?action=BookQuery" method = "POST">
						&nbsp; &nbsp;	
						<select name = "selectAction" size = "1">
							<option value = "QueryById">按id查询</option>
							<option value = "QueryByName">按书名查询</option>
						</select>
						<input type = "text" name = "idOrName" size = "10"/><br/><br/>
						&nbsp; &nbsp; &nbsp;
				...
				<td>
					...
					<p>
						<%
							...
							out.print("I D：" + book.getId() + "<br/>");	
							out.print("书名：" + book.getName() + "<br/>");		
							out.print("作者：" + book.getAuthor() + "<br/>");	
							out.print("出版社：" + book.getPress() + "<br/>");	
							out.print("出版日期：" + book.getPressDate() + "<br/>");	
							out.print("价格：" + book.getPrice() + "元" + "<br/>");								
							out.print("库存量：" + book.getAmount() + "<br/>");									
						
						%>	
					</p>
					
					<form action = "action?action=BookDelete" method = "POST">
												
						&nbsp; 
						<%
							out.print("<input type = 'submit' name = '" + book.getId() + "'" + " value = '删    除 ' /><br/>");
...
<td class='titleCenter titleCenter310' valign='top'>
<div class='titleText titleText310'><span></span></div>
</td>
<td class='titleRight titleRight310' valign='top'>
</td>
</tr></table>
</td>
<td class='right right310'></td>
</tr></table>
<table class='formMiddle formMiddle310' style='' cellpadding='0' cellspacing='0'><tr>
<td class='formMiddleLeft formMiddleLeft310'></td>
<td class='formMiddleCenter formMiddleCenter310' valign='top'>
<div class='formMiddleContent formMiddleContent310  '>
...
<div id='module7' _indexClass='formIndex2' class='form form7 formIndex2 formStyle1' title='' style='' _side='0' _inTab='0' _inMulMCol='0' _inFullmeasure='0' _autoHeight='1' _global='false' _independent='false' >
...
<table class='formBanner formBanner7' cellpadding='0' cellspacing='0'><tr>
<td class='left left7'></td>
<td class='center center7' valign='top'>
<table cellpadding='0' cellspacing='0' class='formBannerTitle formBannerTitle7'><tr>
<td class='titleLeft titleLeft7' valign='top'>
</td>
<td class='titleCenter titleCenter7' valign='top'>
<div class='titleText titleText7'><span></span></div>
</td>
<td class='titleRight titleRight7' valign='top'>
</td>
</tr></table>
</td>
<td class='right right7'></td>
</tr></table>
<table class='formMiddle formMiddle7' style='' cellpadding='0' cellspacing='0'><tr>
<td class='formMiddleLeft formMiddleLeft7'></td>
<td class='formMiddleCenter formMiddleCenter7' valign='top'>
<div class='formMiddleContent formMiddleContent7  '>
<div class='richContent richContent0'><p><a href="http://www.baidu.com" target="_self" title="百度" jumptype="0" jumpurl="http://www.baidu.com" jumpide="http://www.baidu.com" jumpname="www.baidu.com" style="text-decoration:underline;"></a></p></div></div>
</td>
...
<div id='module311' _indexClass='formIndex3' class='form form311 formIndex3 formStyle40' title='' style='' _side='0' _inTab='0' _inMulMCol='0' _inFullmeasure='0' _autoHeight='1' _global='true' _independent='false' >
...
<div class='titleText titleText311'><span></span></div>
</td>
...
<table class='formBottom formBottom27' cellpadding='0' cellspacing='0'><tr><td class='left left27'></td><td class='center center27'></td><td class='right right27'></td></tr></table>
				...
				<li class='footerItemSection'>
					...
					<table class='footerItemContainer'>
						<tr>
							<td class='footerItemContainer-firstTd'>
								<div class='footerItemPic'>
									<a href='javascript:;' class='footerItemNormalPic ' id='footerItemPic5' >
									</a>
								</div>
							</td>
							<td class='footerItemContainer-secondTd'>
								<div class='footerItemContent'>
									<div class='footerItemTop'>
										<a title='' class='footerItemTopLink' href='/about.jsp'  child='0'>关于我们</a>
					...
					<table class='footerItemContainer'>
						<tr>
							<td class='footerItemContainer-firstTd'>
								<div class='footerItemPic'>
									<a href='javascript:;' class='footerItemNormalPic ' id='footerItemPic6' >
									</a>
								</div>
							</td>
							<td class='footerItemContainer-secondTd'>
								<div class='footerItemContent'>
									<div class='footerItemTop'>
										<a title='' class='footerItemTopLink' href='/contact.jsp'  child='0'>联系我们</a>
