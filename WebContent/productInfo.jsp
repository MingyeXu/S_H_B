...
<!--  right end*/  -->
	...
	<div class='left'>
			...
			<div style="float:left;">
				<a  id="topBarMember_myProfile" hidefocus="true" style="text-decoration:none;display:none;"  href="mCenter.jsp">我的资料</a>
			</div>	
	
			<div id="line2" class="line" style="float:left;display:none;"></div>
			<div style="float:left;">
				<a id="topBarMember_myOrder" hidefocus="true" style="text-decoration:none;display:none;" href="mCenter.jsp?item=memberOrder">我的订单</a>
			</div>
...
<div class='titleText titleText27'><h3>商品列表</h3></div>
</td>
...
<td class='msgText'></td>
     ...
     <table border="0" cellpadding="10" cellspacing="0">
            <tr>
                <td height="11" class="td1">书名</td>
                <td class="td1">详细信息</td>
              <td class="td1">选择购买量</td>
                <td class="td8">买买买？</td>
   </tr>
	              <tr>
	                <td class="td2">Web应用开发</td>
	                <form action="product?product=info01" method="POST">
	                	<td class="td4"><input type='submit' value='详细信息'/></td>
	                </form>
	                <form action="product?product=B0001" method="POST">
	                	<td class="td4"><input name="amount"/></td><td class="td4"><input type='submit' value='加入购物车'/></td>
	                </form>
	            </tr>
	            ...
	            <tr>
	                <td class="td2">数据库</td>
	                <form action="product?product=info02" method="POST">
	                	<td class="td4"><input type='submit' value='详细信息'/></td>
	                </form>
	                 <form action="product?product=B0002" method="post">
	               		<td class="td4"><input name="amount"/></td> <td class="td4"><input type='submit' value='加入购物车'/></td>
	                </form> 
	            </tr>
           
	            <tr>
	                <td class="td2">数据结构</td>
	                <form action="product?product=info03" method="POST">
	                	<td class="td4"><input type='submit' value='详细信息'/></td>
	                </form>
	                 <form action="product?product=B0003" method="post">
	               		 <td class="td4"><input name="amount"/></td><td class="td4"><input type='submit' value='加入购物车'/></td>
	                </form> 
	            </tr>
	            ...
	            <tr>
	                ...
	                <form action="product?product=info04" method="POST">
	                	<td class="td4"><input type='submit' value='详细信息'/></td>
	                </form>
	                <form action="product?product=B0004" method="post">
	               		 <td class="td4"><input name="amount"/></td><td class="td4"><input type='submit' value='加入购物车'/></td>
	                </form>
	            </tr>
	            ...
	            <tr>
	                <td class="td2">算法设计与分析</td>
	                <form action="product?product=info05" method="POST">
	                	<td class="td4"><input type='submit' value='详细信息'/></td>
	                </form>
	                 <form action="product?product=B0005" method="post">
	               		 <td class="td4"><input name="amount"/></td><td class="td4"><input type='submit' value='加入购物车'/></td>
	   	             </form>
	            </tr>
	            ...
	            <tr>
	                <td class="td2">mysql</td>
	                <form action="product?product=info06" method="POST">
	                	<td class="td4"><input type='submit' value='详细信息'/></td>
	                </form>
	                 <form action="product?product=B0006" method="post">
	              		 <td class="td4"><input name="amount"/></td> <td class="td4"><input type='submit' value='加入购物车'/></td>
	                 </form>           		  
	   	            </tr>
	            ...
	            <tr>
	                <td class="td2">C++</td>
	                <form action="product?product=info07" method="POST">
	                	<td class="td4"><input type='submit' value='详细信息'/></td>
	                </form>
	                <form action="product?product=B0007" method="post">
	               		 <td class="td4"><input name="amount"/></td><td class="td4"><input type='submit' value='加入购物车'/></td>
	                </form>
	            </tr>
	            ...
	            <tr>
	                ...
	                <form action="product?product=info08" method="POST">
	                	<td class="td4"><input type='submit' value='详细信息'/></td>
	                </form>
	                <form action="product?product=B0008" method="post">
	              		  <td class="td4"><input name="amount"/></td><td class="td4"><input type='submit' value='加入购物车'/></td>
	              	</form> 
	            </tr>
	            ...
	            <tr>
	                ...
	                <form action="product?product=info10" method="POST">
	                	<td class="td4"><input type='submit' value='详细信息'/></td>
	                </form>
	                <form action="product?product=B0010" method="post">
	                		<td class="td4"><input name="amount"/></td><td class="td4"><input type='submit' value='加入购物车'/></td>
	                </form> 
	            </tr>
	            ...
	            <tr>
	                <td class="td2">jquery</td>
	                <form action="product?product=info11" method="POST">
	                	<td class="td4"><input type='submit' value='详细信息'/></td>
	                </form>
	                <form action="product?product=B0011" method="post">
	              		  <td class="td4"><input name="amount"/></td><td class="td4"><input type='submit' value='加入购物车'/></td>
	              	</form>
	            </tr>
</table>
